...
| `Assets/Scripts/UiWindowsMvp/Runtime/R3Integration` | `UiWindowsMvp.Reactive` | `UiWindowsMvp.Reactive` | Minimal R3 compile boundary and conventions support. No presenter adapter or model behavior exists in `UIW-13`. |
