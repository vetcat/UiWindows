        ...
        public IEnumerator ReopenCyclesThroughWindowSystem_ReusePooledWindowWithoutDuplicateSubscriptions()
        {
            ...
            try
            {
                ...
                for (var cycle = 0; cycle < 3; cycle++)
                {
                    ...
                    Assert.That(view.HealthData.TextValue.text, Is.EqualTo($"{player.Settings.MaxHealth} / {player.Settings.MaxHealth}"));
                    ...
                    Assert.That(WindowPresenterBinder.TryGetBinding(launcher.CurrentWindow, out var reopenedBinding), Is.True);
