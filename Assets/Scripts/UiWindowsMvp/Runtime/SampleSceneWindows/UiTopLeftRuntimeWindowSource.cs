...
{
    internal sealed class UiTopLeftRuntimeWindowSource : IDisposable
    {
        private const int MainLayoutTagId = 1;
        private const int MainLayoutLocalTagId = 1;

        private readonly WindowLayout layoutSource;
        private bool disposed;

        private UiTopLeftRuntimeWindowSource(UiTopLeftWindow windowSource, WindowLayout layoutSource)
        {
            WindowSource = windowSource;
            this.layoutSource = layoutSource;
        }

        public UiTopLeftWindow WindowSource { get; }

        public static UiTopLeftRuntimeWindowSource Create(UiTopLeftView viewPrefab)
        {
            if (viewPrefab == null)
            {
            ...
            return new UiTopLeftRuntimeWindowSource(window, layout);
        }
        ...
        private static UiTopLeftWindow CreateWindowSource(WindowLayout layout, UiTopLeftView viewPrefab)
        {
            var gameObject = new GameObject("UiTopLeftWindow Source", typeof(RectTransform));
            ...
            var cameraObject = new GameObject("UiTopLeftWindow Camera", typeof(Camera));
        ...
        private static WindowLayout CreateLayoutSource()
        {
            ...
            var elementObject =
                new GameObject("UiTopLeftWindow Slot", typeof(RectTransform), typeof(WindowLayoutElement));
        ...
        private static Resource CreateDirectComponentResource(UiTopLeftView viewPrefab)
        {
            return new Resource
            {
