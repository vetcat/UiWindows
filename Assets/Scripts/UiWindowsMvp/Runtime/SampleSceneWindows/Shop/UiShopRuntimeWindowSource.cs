...
{
    internal sealed class UiShopRuntimeWindowSource : IDisposable
    {
        ...
        private UiShopRuntimeWindowSource(UiShopWindow windowSource, WindowLayout layoutSource)
        {
            WindowSource = windowSource;
            this.layoutSource = layoutSource;
        }

        public UiShopWindow WindowSource { get; }

        public static UiShopRuntimeWindowSource Create(UiShopView viewPrefab)
        {
            if (viewPrefab == null)
            {
            ...
            return new UiShopRuntimeWindowSource(window, layout);
        }
        ...
        private static UiShopWindow CreateWindowSource(WindowLayout layout, UiShopView viewPrefab)
        {
            var gameObject = new GameObject("UiShopWindow Source", typeof(RectTransform));
            UnityEngine.Object.DontDestroyOnLoad(gameObject);

            var window = gameObject.AddComponent<UiShopWindow>();
            ...
            var cameraObject = new GameObject("UiShopWindow Camera", typeof(Camera));
        ...
        private static WindowLayout CreateLayoutSource()
        {
            ...
            var elementObject = new GameObject("UiShopWindow Slot", typeof(RectTransform), typeof(WindowLayoutElement));
        ...
        private static Resource CreateDirectComponentResource(UiShopView viewPrefab)
        {
            return new Resource
            {
